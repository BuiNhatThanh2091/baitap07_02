...
public class BlueControl extends AppCompatActivity {
    ...
    String address = null;
    private String mode = "SIMULATION"; // Default to simulation
        ...
        btnDis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ("REAL".equals(mode)) {
                    ...
                    finish(); // In simulation, just go back
                }
            }
        });
    }
    ...
    private void sendControlSignal(String onSignal, String offSignal) {
        if (btSocket != null && isBtConnected) {
            try {
                // This logic is a bit simplistic, assuming we track state. A better way is to get state from device.
                // For now, we will just toggle.
