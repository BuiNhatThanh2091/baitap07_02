...
public class MainActivity extends AppCompatActivity {
    ...
    private String currentMode = "SIMULATION"; // To track which list is shown
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (myBluetooth == null) {
            // In a real app, you might disable BT features. For our mixed-mode, we can allow simulation.
    ...
    private void listPairedDevices() {
        ...
        if (!myBluetooth.isEnabled()) {
            ...
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
                return; // Permissions are checked before calling this.
            }
    ...
    private final AdapterView.OnItemClickListener myListClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            i.putExtra("MODE", currentMode); // Pass the selected mode to the next activity
            startActivity(i);
        }
    };
